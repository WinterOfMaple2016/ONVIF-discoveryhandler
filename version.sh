...
if [ "$CHECK" == "1" ]; then
    ...
    CARGO_FILES="$BASEDIR/shared/Cargo.toml $BASEDIR/discovery-utils/Cargo.toml $BASEDIR/discovery-handlers/onvif/Cargo.toml $BASEDIR/discovery-handler-modules/onvif-discovery-handler/Cargo.toml"
